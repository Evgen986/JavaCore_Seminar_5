...
//        writeFileContents("test1.txt", 90);
//        writeFileContents("test2.txt", 90, 3);
//        System.out.println(findInFile("test2.txt", TO_SEARCH));
//        concatenate("test1.txt", "test2.txt", "result.txt");
        backup("./src", DIR_BACKUP);
//        Path path1 = Paths.get("./src/main/java/org/example/Main.java");
//        Path path2 = Paths.get("./backup");
//        Path pathS = Path.of("./");
//        File file = new File("./src/main/java/resources");
//        System.out.println("Длина " + file.length());
//        System.out.println("Путь " + pathS.relativize(path1));
//        System.out.println("Путь " + path2.resolve(pathS.relativize(path1)));
    }
    ...
    public static void backup(String dirSource, String dirTarget) {
        ...
        // Проверяем, если директория существует, стираем ее.
